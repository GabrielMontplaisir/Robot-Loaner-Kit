function sendEmail() {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (calData[0].find(booking => booking === person.name+' - '+person.school)) {
      ...
      if (nextBooking === '') {
        nextBooking = 'B&LT Greenbank - 4th Floor - Attention Consultants';
      }
    ...
    MailApp.sendEmail({
     ...
     <p>Don’t forget to complete the <a href='${feedbackForm}'>Robot Experience Form</a> and email us any pictures you would like to share. We would love to see celebrations of student learning. If your school is interested in purchasing their own set of robots, please contact ...</p>
